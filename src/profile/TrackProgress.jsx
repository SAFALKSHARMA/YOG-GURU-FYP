    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="flex justify-between items-center mb-10">
          ...
          <button
            onClick={openModal}
            className="bg-white text-gray-800 px-6 py-3 rounded-lg shadow-md flex items-center space-x-2 hover:bg-gray-100 border border-gray-200 transition-all duration-200"
            disabled={isLoading}
          >
            <svg
            ...
            <span>{isLoading ? "Loading..." : "New Entry"}</span>
          </button>
        </div>

        {error && (
          <div className="bg-white border-l-4 border-red-500 text-red-700 p-4 rounded-lg shadow-sm mb-8 animate-pulse">
        ...
        {isModalOpen && (
          <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
            <div className="bg-white p-8 rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-fadeIn">
              ...
              {error && (
                <div className="bg-white border-l-4 border-red-500 text-red-700 p-4 rounded-lg mb-6">
                  <div className="flex">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 mr-2"
              ...
              <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 p-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-200 focus:border-gray-300 transition-all duration-200"
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      className="w-full p-4 border border-gray-200 rounded-lg focus:ring-2 focus:ring-gray-200 focus:border-gray-300 transition-all duration-200"
                      rows="4"
                ...
                <div className="flex justify-end space-x-4 pt-6">
                  <button
                    onClick={closeModal}
                    className="px-6 py-3 border border-gray-200 rounded-lg hover:bg-gray-50 text-gray-600 transition-colors duration-200 font-medium"
                    disabled={isLoading}
                  >
                    Cancel
                  </button>
                  <button
                    onClick={submitEntry}
                    className="bg-gray-800 hover:bg-gray-700 text-white px-6 py-3 rounded-lg shadow-sm transition-all duration-200 font-medium"
                    disabled={isLoading}
                  >
                    {isLoading ? (
