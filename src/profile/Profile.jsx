...
const user = {
  ...
  favoritePets: [
    ...
    },
    {
      ...
      status: "Available",
      image:
        "https://images.unsplash.com/photo-1425082661705-1834bfd09dca?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
    },
    {
      id: 4,
      name: "Max",
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          ...
          <div className="mt-8 lg:mt-0 lg:col-span-9">
            ...
            {activeTab === "favorites" && (
              <FavoriteClasses favoritePets={user.favoritePets} />
            )}
